...
description: Behavioral guidelines to reduce common LLM coding mistakes and ensure code quality. Use when writing, reviewing, or refactoring code to avoid overcomplication, make surgical changes, surface assumptions, and define verifiable success criteria.
license: MIT
---
